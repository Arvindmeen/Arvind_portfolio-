...
export const projects = [
  ...
  {
    title: 'Analysis of Traffic Speed Variance and Compliance on Urban Collectors',
    desc: "Analyzed 194,130+ NYC DOT speed observations to evaluate roadway safety, 85th-percentile speeds (54.68 mph), and speed variance. Conducted Welch's t-test and Fisher's exact test identifying significant off-peak speed surges (+3.62 mph, 1.22 RR), modeling hazard screening and safety control frameworks.",
    tags: ['Python', 'Statistical Analysis', 'Hypothesis Testing', 'Data Science', 'Risk Modeling', 'Pandas'],
    iconKey: 'traffic',
    gradient: 'from-rose-600 to-red-700',
    demo: 'https://github.com/Arvindmeen/Analysis-of-Traffic-Speed-Variance-and-Compliance-on-Urban-Collectors',
    repo: 'https://github.com/Arvindmeen/Analysis-of-Traffic-Speed-Variance-and-Compliance-on-Urban-Collectors',
  },
  {
    title: 'Medical Insurance Cost Prediction using Linear Regression',
    desc: 'Developed a machine learning regression model from scratch using the Normal Equation and Moore–Penrose pseudoinverse to predict healthcare charges. Engineered nonlinear features and interaction terms (Smoker × BMI), achieving 0.869 test R² and 4513 RMSE, with 5-fold cross-validation and L2 Ridge regularization.',
    tags: ['Python', 'Machine Learning', 'Linear Regression', 'Feature Engineering', 'Ridge Regression', 'Scikit-Learn'],
    iconKey: 'insurance',
    gradient: 'from-cyan-600 to-blue-700',
    demo: 'https://github.com/Arvindmeen/Medical-Insurance-Cost-Prediction-using-Linear-Regression',
    repo: 'https://github.com/Arvindmeen/Medical-Insurance-Cost-Prediction-using-Linear-Regression',
  },
  {
